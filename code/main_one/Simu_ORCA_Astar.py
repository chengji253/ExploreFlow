...
class Simu_ORCA_Astar:

    def __init__(self):
        # self.pic_name = "pic/map_yaml/m1-v.yaml"
        self.pic_name = "../pic/map_yaml/m1-500-hard.yaml"
        # self.pic_name = "../pic/map_yaml/m1-500-1.yaml"
        # self.pic_name = "../pic/map_yaml/m1-100-maze.yaml"
    ...
    def setup_scenario(self):
        ...
        self.name = "../result/test_Astar" + "/snap" + str(self.simulator.getGlobalTime()) + ".png"
    ...
    def update_visualization(self, t):
        ...
        self.name = "../result/test_Astar" + "/snap" + str(t) + ".png"
        ...
        # visualize_traj_wait_red_robot(self.simulator.agents_, self.simulator.obs_info, self.simulator.goals_info,
        #                        self.boundary, self.name, self.swarm, time)
    ...
    def main(self):
        ...
        #                      self.non_zero_mean_density, "../density_data/Astar_density.json")
        save_wait_num_json(self.num_wait_red_list, "../density_data/Astar_wait.json")
