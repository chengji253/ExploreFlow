...
from RVO_module.RVO import RVO_update, reach, compute_V_des, reach
...
class Simu_main:
    ...
    def __init__(self):
        # self.pic_name = "map_info/pic/real_ex5-1.png"
        self.pic_mapInfo = "pic/maze/maze1.png"
        self.pic_mapCo = "pic/maze/maze1co.png"
        ...
        self.mapInfo = map_info.MapInfo(self.swarm, self.pic_mapInfo)
        self.mapInfo_Co = map_info.MapInfo(self.swarm, self.pic_mapCo)
    ...
    def planner_run(self):
        # self.mapInfo.find_current_path_set_edge()
        self.mapInfo.find_current_path_set_edge()
        ...
        # self.flow_planner.position_allocation_greedy_goal()
    ...
    def compute_V_RVO(self, ws_model):
        ...
        V = RVO_update(self.swarm.pos_all, V_des, self.swarm.V_all, ws_model,
                       self.swarm.robot_exist, self.swarm.around_no_robots)
        self.swarm.V_all = V
...
print("planner num=" + str(s1.planner_run_num))
print("planner ave time=" + str(s1.planner_time/s1.planner_run_num) + "s")